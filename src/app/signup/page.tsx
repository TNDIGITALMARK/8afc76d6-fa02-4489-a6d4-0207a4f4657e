 ...
 *
 * Clean, minimal design following white theme.
 * Easy customization points:
 * - Replace Card with custom container
 * - Add/remove form fields (phone, company, etc.)
 * - Customize validation rules
 * - Add social auth buttons (Google, GitHub, etc.)
 * - Change redirect destination after signup
      ...
      <Card className="w-full max-w-md border-border shadow-sm">
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Terms of Service - Uncomment to add
            <div className="flex items-start space-x-2">
              ...
              <Label htmlFor="terms" className="text-sm leading-relaxed">
                I agree to the{' '}
                <Link href="/terms-of-service" className="font-medium underline">
                  Terms of Service
                </Link>{' '}
                and{' '}
            ...
            */}
            ...
            {/* Divider - Uncomment to add social auth
            ...
            */}
            ...
            {/* Social Auth Buttons - Uncomment and customize as needed
